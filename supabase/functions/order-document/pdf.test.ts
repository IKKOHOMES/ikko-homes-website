...
Deno.test('renders a branded invoice PDF with the public IKKO Homes logo', async () => {
  ...
  const result = await buildOrderPdf({
    documentType: 'invoice', reference: 'IKKO-1001', issuedOn: '2026-08-28', dueOn: '2026-09-15',
    customer: { name: 'Zebin Hu', email: 'client@example.com', phone: '0400 000 000', address: '69 Patricia Loop' },
    studio: { address: '69 Patricia Loop, Keysborough VIC 3173', email: 'accounts@ikkohomes.com', phone: '0490 384 021' },
    lines: [{ description: 'Deposit - ORD-1001', quantity: 1, unitPrice: 500 }], total: 500,
  });
