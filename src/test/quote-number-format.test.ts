...
test('formats a monthly order number with a four-digit sequence', () => {
  expect(formatOrderNumber('2026-09-01', 1)).toBe('ORD-2026090001');
  expect(formatOrderNumber('2026-09-01', 42)).toBe('ORD-2026090042');
});
